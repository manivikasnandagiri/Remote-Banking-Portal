      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-md-8 text-color">
            <h1>Welcome to Remote Banking Portal  System</h1>
            <p>
              Welcome to our cutting-edge Remote Banking Portal System, where financial
        ...
        <div className="row mt-5">
          ...
          <div className="col-md-8 text-color">
            ...
            <p className="ms-5">
              ...
              Remote Banking Portal System. Seamlessly manage transactions, deposits,
